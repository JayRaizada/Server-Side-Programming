...
// Example usage:
let mainString =
  "This is an example sentence with the word 'example' repeated multiple times. This example demonstrates how to find all occurrences of a specific word.";
